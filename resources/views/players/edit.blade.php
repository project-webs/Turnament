        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('players.update', $player) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" required value="{{ old('name', $player->name) }}" placeholder="Contoh: Budi Santoso">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nik" id="nik" class="form-control" value="{{ old('nik', $player->nik) }}" placeholder="Contoh: 3171234567890001">
                    @error('nik') <div class="form-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="address" class="form-label">Alamat Lengkap</label>
                    <textarea name="address" id="address" class="form-control" placeholder="Contoh: Jl. Sudirman No. 1, Jakarta">{{ old('address', $player->address) }}</textarea>
                    @error('address') <div class="form-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="division" class="form-label">Divisi (Opsional)</label>
                    <input type="text" name="division" id="division" class="form-control" value="{{ old('division', $player->division) }}" placeholder="Contoh: Divisi 1, Umum, U-19">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="itr_rating" id="itr_rating" class="form-control" value="{{ old('itr_rating', $player->itr_rating) }}" min="0">
                ...
                <div style="margin-top:32px;display:flex;justify-content:flex-end;gap:12px">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa-solid fa-save"></i> Perbarui Peserta
                    </button>
                </div>
            </form>
        </div>
